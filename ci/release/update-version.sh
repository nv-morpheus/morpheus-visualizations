...
sed_runner "s|example: ${CURRENT_SHORT_TAG}|example: ${NEXT_SHORT_TAG}|g" .github/ISSUE_TEMPLATE/bug_report.yml

# DFP/package.json
sed_runner 's|"version": "'"${CURRENT_FULL_VERSION}"'",|"version": "'"${NEXT_FULL_VERSION}"'",|g' DFP/package.json
